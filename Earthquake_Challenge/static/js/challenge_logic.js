...
let plateBoundries = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"

// Use d3.json to make a call to get our Tectonic Plate geoJSON data.
d3.json(plateBoundries).then(function(data) {
  console.log(data);
